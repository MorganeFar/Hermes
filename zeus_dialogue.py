...
dialogue_all = ["Zeus – Hermès ! Que fais-tu ici mon fils ? Quelqu'un t'envoie me porter un message ?",
                ...
                "Zeus – Ton trône ? Le douzième dieu de l'Olympe ? Hahahaha ! Toi devenir dieu de l'Olympe ? Quel audace ! Et qu'est-ce qu'il te fait croire que je vais accepter ta requête ?",
                "Hermès – En tant que messagers des dieux, je peux aller partout où je veux et j'ai des oreilles partout. De plus, je suis de ton côté mon cher père, je peux t'aider à éviter les rébellions en te prévenant avant même que les hommes ou les dieux essayent de te détrôner. Je te propose donc mes services contre une place à l'Olympe.",
                ...
                "Zeus – Ça c'est vraiment intéressant. Avant que je proclame ma décision, comment as-tu su quels sont les ingrédients nécessaires à la confection de ce trône ? Je garde toujours la liste des ingrédients sur moi … *regarde dans sa poche* Elle n'est plus là ! Est-ce toi qui me l'a volé ?!", 
...
background = pygame.image.load("olympe.png")
...
zeus = Scenery(0.6, 0.1, 0.3, 0.6, ["zeus.png"])
olympeGroup.add(zeus)

hermes = Scenery(0.15, 0.31, 0.14, 0.4, ["../../hermes/hermes_s.png"])
olympeGroup.add(hermes)

def chaise():
    chair = Scenery(0.3, 0.4, 0.16, 0.32, ["../nv_4_hephaistos/trone.png"])
...
speed = 2 #on a 1 caract tous les 3 tics 
