...
level_2 = {'terrain': '../../design/niveau2/map/level_2_map_terrain.csv',
           ...
           'rotation': -90,
           'air': '../../design/niveau2/map/level_2_map_air.csv',
           ...
           'dialogue_mauv_obj2': ["Hermes – J'ai du beurre de cacahuète.", 
                              "Poséidon – Sérieusement ? Tu penses vraiment que c'est équivalent à mes pierres ?",
                              "Hermes – Je n'ai rien d'autre à t'échanger.",
                              "Poséidon – Ha ha ha j'en était sur ! Si tu veux mes pierres, trouve donc mon trident, je l'ai perdu quelque part dans l'océan.",
                              "*défaite, retour au début du niveau* *appuyez sur 'e' pour sortir*"],
           'dialogue_no': ["Hermes – Je n'ai rien à t'échanger.",
                           "Poséidon – Ha ha ha j'en était sur ! Si tu veux mes pierres, trouve donc mon trident, je l'ai perdu quelque part dans l'océan.",
...
level_4 = {'terrain': '../../design/niveau4/map/level_4_map_terrain.csv',
           ...
           'stalactite':'../../design/niveau4/map/level_4_map_stalactite.csv',
           'piege':'../../design/niveau4/map/level_4_map_piege.csv',
...
level_5 = {'terrain': '../../design/niveau5/map/level_5_map_terrain.csv',
           'player':'../../design/niveau5/map/level_5_map_player.csv',
           'death_line':'../../design/niveau5/map/level_5_map_death_line.csv',
           'node_pos': (910,210),
           'unlock': 5,
           ...
           'mauv_obj1': None,
           'mauv_obj2': None,
           'dialogue_all': ["Hermès – Wow ces chaussures sont prafaitement à ma taille ! Je vais arriver au mont Olympe en moins de deux !",
                           "Héra - HERMES ! Je t'ai retrouvé petit avorton ! Prépare toi à mourrir !",
                           "Hermès – C'est Héra ! Vite il faut fuire !"],
           'dialogue_bon_obj': ["*vous fuyez vers le mont Olympe en volant*",
                                "*appuyez sur 'e' pour sortir*"],
           'dialogue_mauv_obj1': ["*vous fuyez vers le mont Olympe en volant*",
                                  "*appuyez sur 'e' pour sortir*"],
           'dialogue_mauv_obj2': ["*vous fuyez vers le mont Olympe en volant*",
                                "*appuyez sur 'e' pour sortir*"],
           'dialogue_no': ["*vous fuyez vers le mont Olympe en volant*",
                                "*appuyez sur 'e' pour sortir*"],
           'dialogue_recom': ["Hermès – C'est Héra ! Vite il faut fuire !"]
            }

the_end = {'dieu': ['../../design/the_end/zeus.png'], 
           'place_dieu': [0.6, 0.1, 0.3, 0.6],
           'bon_obj': None,
           'mauv_obj1': None,
           'mauv_obj2': None,
           'dialogue_all': ["Zeus – Hermès ! Que fais-tu ici mon fils ? Quelqu'un t'envoie me porter un message ?",
                           ...
                           "*Victoire ! Toutes mes félicitations voyageur, vous avez réussi à conquérir l'Olympe !*"],
           'dialogue_bon_obj': ["*appuyez sur 'e' pour sortir*"],
           'dialogue_mauv_obj1': ["*appuyez sur 'e' pour sortir*"],
           'dialogue_mauv_obj2': ["*appuyez sur 'e' pour sortir*"],
           'dialogue_no': ["*appuyez sur 'e' pour sortir*"],
